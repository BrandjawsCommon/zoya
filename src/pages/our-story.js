      ...
      <div className="py-[60px] xl:py-20 xl:pb-[100px]">
        <div className="container">
          ...
          <p className="text-[16px] lg:text-[20px] xl:text-[24px] leading-[20.18px] lg:leading-[24.19px] xl:leading-[28.18px] font-light w-full lg:w-[82%]">
            ...
            forwardthinking initiatives have brought it into the global
            spotlight, making it an ideal destination for Zoya Developments to
            expand. With a customer-centric approach at our core, we look
        ...
        <div className="container h-full">
          <div className="flex items-center flex-col lg:flex-row gap-0 lg:gap-[10px] xl:gap-[50px] h-full ">
            <div className="w-full lg:w-[70%]">
              ...
              <img
                src="/Comas-Icon.svg"
                className="w-[130px] xl:w-[200px] mb-5 xl:mb-10"
              />
          ...
          <div className="flex items-start flex-wrap justify-between gap-[25px] xl:gap-[40px] mb-5 lg:mb-10 xl:mb-14">
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              ...
              <p className="text-[16px] leading-[1.5] font-light text-white">
                ...
                elevate livability for generations to come.
              </p>
            </div>
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              <img
              ...
              <p className="text-[16px] leading-[1.5] font-light text-white">
                ...
                prioritize convenience and security.
              </p>
            </div>
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              <img
              ...
              <p className="text-[16px] leading-[1.5] font-light text-white">
                ...
                outdoor spaces are just some elements we consider to create
                environments that enhance your well-being.
              </p>
            </div>
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              <img
      ...
      <div className="bg-white py-[60px] lg:py-20 xl:py-[100px]">
        <div className="container">
          ...
          <p className="text-[16px] lg:text-[20px] leading-[20.18px] lg:leading-[24.19px] font-light w-full lg:w-[82%] mt-5 mb-10 xl:mb-[80px]">
            At Zoya Developments, we believe our greatest asset is our people.
            We’ve assembled a team of passionate and dedicated professionals,
          ...
          <div className=" mb-5 lg:mb-10 xl:mb-14">
            <div className="w-full flex flex-col justify-end mb-10">
              ...
              <p className="text-[16px] lg:text-[18px] leading-[21px] lg:leading-[23px] font-light text-black">
                ...
                helm, guiding our direction and propelling us towards a future
            ...
            {/* <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-30px)]">
              <Link href="#." className="relative teamMember Fast_animate">
                ...
                <p className="text-[14px] lg:text-[16px] leading-normal font-light text-black mb-4 h-[70px] overflow-scroll scrollParagraph">
                  Mr. Farooq, respected for his industry insights and business
                  acumen, has led the group for over 20 years. With a unique
                  vision and global approach, he sets high standards and is
                  deeply involved in every project. A man of action, he embodies
                  the “speak less, do more” philosophy and skillfully manages
                  the group’s diverse operations. His uncanny knowledge of the 3
                  M’s of real estate development - man, machines and materials,
                  makes him the operational wizard and a valuable leader.
                </p>
            ...
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-30px)]">
              <Link href="#." className="relative teamMember Fast_animate">
                ...
                <p className="text-[14px] lg:text-[16px] leading-normal font-light text-black mb-4 h-[70px] overflow-scroll scrollParagraph">
                  ...
                  international experience fosters a fresh approach to business,
                  evident in his innovative ideas and “can-do” attitude. A
                  natural multi-tasker with a strategic mind, Mr. Imtiaz plays a
                  key role in driving the company’s expansion. His passion for
                  project planning and strategic development ensures his
                  contributions are valuable across all facets of the business.
                  Imtiaz has a Degree in Business Administration from Jain-CMS,
                  India & Specialized International Marketing Program from
            ...
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-30px)]">
              <Link href="#." className="relative teamMember Fast_animate">
                ...
                <p className="text-[14px] lg:text-[16px] leading-normal font-light text-black mb-4 h-[70px] overflow-scroll scrollParagraph">
                  Mr. Shoaib Khan, future-oriented leader at Zoya Developments,
                  champions customer focus within the real estate landscape. His
                  financial expertise ensures sound investment decisions and his
                  commitment to continuous learning fuels positive change. Mr.
                  Khan’s arrival marked a shift towards prioritizing customer
                  needs, reflecting Zoya’s dedication to evolving with the
                  market. Shoaib has a Degree in Business Administration from
                  the Jain-CMS & Specialized International Practical Finance
                  Program, UK.
                </p>
                <div className="flex items-center TeamButton">
                  <div>
          ...
          <div className="flex items-start flex-wrap justify-between gap-[25px] xl:gap-[40px] mb-5 lg:mb-10 xl:mb-14">
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              ...
              <p className="text-[16px] lg:text-[18px] leading-normal font-light text-black">
                We embrace bold ideas and a forward-thinking approach,
                constantly seeking new ways to elevate the living experience
                beyond what’s currently imagined.
              </p>
            </div>
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              <h2 className="text-[26px] xl:text-[30px] font-medium text-black leading-[35px] xl:leading-[45px] mb-5 lg:mb-[30px]">
              ...
              <p className="text-[16px] lg:text-[18px] leading-normal font-light text-black">
                ...
                we do, from design and construction to resident service,
                ensuring a level of excellence that surpasses comparison.
              </p>
            </div>
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              <h2 className="text-[26px] xl:text-[30px] font-medium text-black leading-[35px] xl:leading-[45px] mb-5 lg:mb-[30px]">
              ...
              <p className="text-[16px] lg:text-[18px] leading-normal font-light text-black">
                ...
                celebrated, fostering collaboration that transcends borders and
                limitations.
              </p>
            </div>
            <div className="w-full md:w-[calc(50%-25px)] xl:w-[calc(25%-40px)]">
              ...
              <p className="text-[16px] lg:text-[18px] leading-normal font-light text-black">
                ...
                prioritizing their needs and exceeding their expectations in
        ...
        <div className="bg-black bg-opacity-[20%] py-[60px] xl:py-20 xl:pb-[100px] w-full flex justify-center">
          <div className="container">
            ...
            <p className="text-[20px] lg:text-[30px] xl:text-[35px] text-white leading-[26.96px] lg:leading-[36.96px] xl:leading-[41.96px] w-full xl:w-[72%] font-medium">
              At Zoya Developments, we’re not content with the status quo. We’re
              actively seeking new frontiers, bringing our visionary approach to
              a wider audience.
              <br />
              <br />
              This expansion will be guided by a deep understanding of local
              needs, ensuring we seamlessly integrate into the fabric of every
              new community we serve.
            </p>
            <p className="text-[16px] lg:text-[20px] text-white leading-[20.18px] lg:leading-[24.19px] xl:leading-[28.18px] font-light w-full lg:w-[82%] mt-5 lg:mt-10 xl:mt-14">
              We believe the future of living is brimming with exciting
              possibilities. By working hand-in-hand with residents, investors,
              and partners who share our vision of innovation and excellence, we
              can create a future where exceptional living experiences are
              accessible to all.
            </p>
          </div>
        </div>
