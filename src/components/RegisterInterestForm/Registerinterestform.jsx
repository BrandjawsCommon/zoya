...
const Registerinterestform = ({ togglePopup }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://hooks.zapier.com/hooks/catch/4631356/24j8e5r/", // Zapier webhook URL
        {
          method: "POST",
...
//     try {
//       const response = await fetch(
//         "https://hooks.zapier.com/hooks/catch/4631356/24j8e5r/", // Updated Zapier URL
//         {
//           method: "POST",
//         //   headers: {
//         //     "Content-Type": "application/json", // Ensure JSON data format
