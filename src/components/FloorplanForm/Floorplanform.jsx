...
const Floorplanform = ({ togglePopup }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://hooks.zapier.com/hooks/catch/4631356/24j8e3d/", // Zapier webhook URL
        {
          method: "POST",
...
//     try {
//       const response = await fetch(
//         "https://hooks.zapier.com/hooks/catch/4631356/24j8e3d/", // Updated Zapier URL
//         {
//           method: "POST",
//         //   headers: {
