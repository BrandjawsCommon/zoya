  ...
  return (
    <>
      ...
      <section className="w-full h-[70vh] Banner relative Banner_overlay">
        <img src="/Detail_Banner.png" alt="Banner" class="w-full h-full object-cover"></img>
          ...
          <div>
            ...
            <div className="flex flex-wrap justify-between my-8 flex-col-reverse md:flex-row gap-9 md:gap-0">
              ...
              <div className="w-full md:w-1/2">
                <img className="w-full h-full" src="/Detail-Inner.png" alt="Detail-Inner" />
              </div>
            </div>
            <p className="text-black font-normal">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
        ...
        <div className="container">
          ...
          <div className="w-full">
            ...
            >
              <SwiperSlide>
                <div>
                  <img className="w-full" src="/Slide1.png" alt="Slide1" />
              ...
              <SwiperSlide>
                <div>
                  <img className="w-full" src="/Slide2.png" alt="Slide2" />
                  <div className="flex justify-between mt-3">
                    <p className="font-light text-sm">29 May, 2024</p>
                    <p className="font-normal text-sm">REAL ESTATE</p>
                  </div>
              ...
              <SwiperSlide>
                <div>
                  <img className="w-full" src="/Slide3.png" alt="Slide3" />
                  <div className="flex justify-between mt-3">
                    <p className="font-light text-sm">29 May, 2024</p>
                    <p className="font-normal text-sm">REAL ESTATE</p>
                  </div>
              ...
              <SwiperSlide>
                <div>
                  <img className="w-full" src="/Slide4.png" alt="Slide4" />
                  <div className="flex justify-between mt-3">
                    <p className="font-light text-sm">29 May, 2024</p>
                    <p className="font-normal text-sm">REAL ESTATE</p>
                  </div>
...
export default MediaCenterDetails;
